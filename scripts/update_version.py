...
def main():
  ...
  plistpath = scriptpath + "/resources/SK100-VST2-Info.plist"
  ...
  plistpath = scriptpath + "/resources/SK100-AU-Info.plist"
  ...
  plistpath = scriptpath + "/resources/SK100-VST3-Info.plist"
  ...
  plistpath = scriptpath + "/resources/SK100-macOS-Info.plist"
  ...
  plistpath = scriptpath + "/resources/SK100-AAX-Info.plist"
  ...
  plistpath = scriptpath + "/installer/SK100.pkgproj"
  ...
  for line in fileinput.input(scriptpath + "/installer/SK100.iss",inplace=1):
