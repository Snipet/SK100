...
# WIN INSTALLER
  ...
  for line in fileinput.input(projectpath + "/installer/" + config['BUNDLE_NAME'] + ".iss",inplace=1):
    ...
    if "OutputBaseFilename" in line:
      if demo:
        line="OutputBaseFilename=SK100 Demo Installer\n"
      else:
        line="OutputBaseFilename=SK100 Installer\n"
    ...
    if "WelcomeLabel1" in line:
     if demo:
       line="WelcomeLabel1=Welcome to the SK100 Demo installer\n"
     else:
       line="WelcomeLabel1=Welcome to the SK100 installer\n"
       
    if "SetupWindowTitle" in line:
     if demo:
       line="SetupWindowTitle=SK100 Demo installer\n"
     else:
       line="SetupWindowTitle=SK100 installer\n"
